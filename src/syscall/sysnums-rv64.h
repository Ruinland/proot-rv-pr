...
static const Sysnum sysnums_rv64[] = {
	[ 0 ] = PR_io_setup ,
	[ 1 ] = PR_io_destroy ,
	[ 2 ] = PR_io_submit ,
	[ 3 ] = PR_io_cancel ,
	...
	[ 290 ] = PR_pkey_free ,
	[ 291 ] = PR_statx ,
	[ 292 ] = PR_io_pgetevents ,
	[ 293 ] = PR_rseq ,
	[ 294 ] = PR_kexec_file_load ,
	...
	[ 444 ] = PR_landlock_create_ruleset	,
	[ 445 ] = PR_landlock_add_rule	,
	[ 446 ] = PR_landlock_restrict_self	,
};
